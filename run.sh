...
mongoimport --db=cse364 --collection=students --authenticationDatabase admin --username admin --password password --type=csv --file=data/students.csv --fields=student_id.string\(\),name.string\(\),email.string\(\),courses_list.string\(\) --columnsHaveTypes 
